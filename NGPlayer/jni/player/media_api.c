...
jint
Java_com_nd2h_ngplayer_VideoSurfaceView_nativeMediaInit(JNIEnv* env, jobject thiz, jstring pFilename)
{
...
jintArray
Java_com_nd2h_ngplayer_VideoSurfaceView_nativeGetMediaResolution(JNIEnv* env, jobject thiz) {
    jintArray lRes;
...
jint
Java_com_nd2h_ngplayer_VideoSurfaceView_nativeGetMediaDuration(JNIEnv* env, jobject thiz) {
...
jint
Java_com_nd2h_ngplayer_VideoSurfaceView_nativeGetMediaFps(JNIEnv* env, jobject thiz) {
    int fps;
...
jint
Java_com_nd2h_ngplayer_VideoSurfaceView_nativePrepareBitmap(JNIEnv* env, jobject thiz,
...
jint
Java_com_nd2h_ngplayer_VideoSurfaceView_nativeGetFrame(JNIEnv* env, jobject thiz)
{
    AVPacket packet;
    int framefinished;
    ...
    jint
Java_com_nd2h_ngplayer_VideoSurfaceView_nativeMediaFinish(JNIEnv* env, jobject thiz, jobject pBitmap)
{
