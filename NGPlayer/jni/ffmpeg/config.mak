...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/dhna/Share/Development/Project/NGPlayer/NGPlayer/jni/ffmpeg/output --disable-shared --enable-static --target-os=linux --arch=arm --enable-cross-compile --cc=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-gcc --cross-prefix=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi- --extra-cflags='-marm -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags='-Wl,--fix-cortex-a8' --disable-doc --enable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-avdevice --enable-filters --disable-yasm --enable-network --enable-protocol=tcp --enable-demuxer=rtsp --enable-decoder=h264
prefix=/home/dhna/Share/Development/Project/NGPlayer/NGPlayer/jni/ffmpeg/output
...
ARCH=arm
CC=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-gcc
CXX=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-g++
AS=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-gcc
LD=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-gcc
DEPCC=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-ranlib
STRIP=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=  -marm -march=armv7-a -mfloat-abi=softfp -mfpu=neon -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -marm -march=armv7-a -mfloat-abi=softfp -mfpu=neon -march=armv7-a -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-windres
DEPWINDRES=/home/dhna/Development/Android/toolchain/android-9/bin/arm-linux-androideabi-gcc
